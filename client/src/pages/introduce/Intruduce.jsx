...
import styles from "./intruduce.module.scss"
...
function Introduce() {
  ...
  const banner_bgr = useRef()
  const product_num = useRef()
  const achieve_num = useRef()
  const pleasure_num = useRef()
  const branch_num = useRef()
  const overview = useRef()
  const intruduce_element = useRef()
  const features = useRef()
  const banner = useRef()
  const authors = useRef()
  const [productNum, setProductNum] = useState(1280)
  const [achieveNum, setAchieveNum] = useState(8)
  const [pleasureNum, setPleasureNum] = useState(3898)
  const [branchNum, setBranchNum] = useState(25)
  function handleParallax() {
    let y =
      window.pageYOffset - banner.current.offsetTop + window.innerHeight - 150
    let percent = (y * 13) / 150
    console.log(y)
    banner_bgr.current.style.transform = `translate(0,${percent}%)`
  }
  useEffect(() => {
            ...
            i = animate(0, 100, {
              ...
              onUpdate: latest => {
                product_num.current.innerText = Math.round(
                  (latest * productNum) / 100,
                )
                achieve_num.current.innerText = Math.round(
                  (latest * achieveNum) / 100,
                )
                branch_num.current.innerText = Math.round(
                  (latest * branchNum) / 100,
                )
                pleasure_num.current.innerText = Math.round(
                  (latest * pleasureNum) / 100,
                )
              },
            })
          }
      ...
      <DefaultLayout>
        {
          <>
            <div className={cx("first_intro", "wrapper")}>
              <div className={cx("overview", "hide")} ref={overview}>
                <Box>
                  <Grid container spacing={2}>
                    <Grid item xs={12} sm={12} md={6} className={cx("item")}>
                      <img
                        className={cx("image")}
                    ...
                    >
                      <div className={cx("detail")}>
                        ...
                        <div className={cx("text")}>
                          ...
                          giới, rất nhiều thương hiệu cho ra đời những mẫu đồng
                          hồ nam chính hãng đa dạng về phong cách, kiểu dáng,
                          màu sắc, kích cỡ… Một chiếc đồng hồ nam cao cấp chính
                          hãng khắc họa một giá trị đích thực khi nói đến phụ
                          kiện xa xỉ dành cho phái mạnh. Hiện nay, đồng hồ là
                          phụ kiện thời trang thiết yếu đối với những người đàn
                          ông hiện đại ngày nay. Trên cổ tay của những người đàn
                          ông thành đạt luôn dành vị trí cho một chiếc đồng hồ
                          nam cao cấp.”
                        </div>
                      </div>
                    </Grid>
              ...
              <div className={cx("features", "wrapper", "hide")} ref={features}>
                <Box>
                  <Grid container spacing={2} justifyContent='center'>
                    <Grid item xs={12} sm={6} md={4} className={cx("_item")}>
                      <div className={cx("item")}>
                        <div className={cx("icon")}>
                          ...
                          >
                            <g>
                              <g>
                                <path d='M341.354,17.104c-2.1-10.1-11.1-17.3-21.4-17.1h-128c-10.3-0.2-19.3,7-21.3,17.1l-17.1,70.4h205.4L341.354,17.104z'></path>
                              </g>
                            </g>
                            <g>
                              <g>
                                <path d='M153.054,424.504l17.5,70.4c2.1,10.1,11,17.3,21.3,17.1h128c10.3,0.2,19.3-7,21.3-17.1l17.1-70.4H153.054z'></path>
                              </g>
                            </g>
                            <g>
                              <g>
        			...
        			C341.254,267.804,331.754,277.304,319.954,277.304z'
                        ...
                        <div className={cx("text")}>
                          <h2 className={cx("title")}>Hàng chính hãng</h2>
        		...
        		l48.625,67.609l-12.356-83.253l26.116-11.27l51.831,67.718l-16.091-83.145l22.1-9.54l20.516,120.123L464.248,309.08z'
                        ...
                        <div className={cx("text")}>
                          <h2 className={cx("title")}>Sản phẩm mới 100%</h2>
                          <p className={cx("detail")}>
                            Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu
                            đối với những người đàn ông hiện đại ngày nay
                          </p>
        		...
        		c0-11.415,9.286-20.702,20.701-20.702c11.419,0,20.709,9.287,20.709,20.702C322.4,305.817,313.11,315.104,301.691,315.104z
        		 M263.206,187.26v-54.948h27.085c10.395,0,23.217,7.8,27.979,16.988l17.525,35.482c0.452,0.873,0.924,1.698,1.419,2.478H263.206z'
                        ...
                        <div className={cx("text")}>
                          <h2 className={cx("title")}>Miễn phí giao hàng</h2>
                          <p className={cx("detail")}>
                            Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu
                            đối với những người đàn ông hiện đại ngày nay
                          </p>
                    ...
                    <Grid item xs={12} sm={6} md={4} className={cx("_item")}>
                      <div className={cx("item")}>
                        ...
                        <div className={cx("text")}>
                          <h2 className={cx("title")}>Giá cả hợp lý</h2>
                          <p className={cx("detail")}>
                            Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu
                            đối với những người đàn ông hiện đại ngày nay
                          </p>
              ...
              <div className={cx("content")}>
                <Grid container spacing={4}>
                  <Grid item xs={6} sm={6} md={3}>
                    <div className={cx("item")}>
                      <h2 className={cx("num")} ref={product_num}></h2>
                      <p className={cx("product")}>SẢN PHẨM</p>
                    </div>
                  </Grid>
                  <Grid item xs={6} sm={6} md={3}>
                    <div className={cx("item")}>
                      <h2 className={cx("num")} ref={achieve_num}></h2>
                      <p className={cx("product")}>GIẢI THƯỞNG</p>
                    </div>
                  </Grid>
                  <Grid item xs={6} sm={6} md={3}>
                    <div className={cx("item")}>
                      <h2 className={cx("num")} ref={pleasure_num}></h2>
                      <p className={cx("product")}>KHÁCH HÀNG HÀI LÒNG</p>
                    </div>
                  </Grid>
                  <Grid item xs={6} sm={6} md={3}>
                    <div className={cx("item")}>
                      <h2 className={cx("num")} ref={branch_num}></h2>
                      <p className={cx("product")}>CHI NHÁNH CỬA HÀNG</p>
                    </div>
                  </Grid>
                </Grid>
              </div>
            </div>
            <div className={cx("authors", "wrapper")} ref={authors}>
                ...
                <Grid item xs={12} sm={6} md={4} className={cx("_item")}>
                  <div className={cx("item")}>
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url('https://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-2-150x150.png')",
                      }}
                    ></div>
                    <p className={cx("detail")}>
                    ...
                    <h3 className={cx("name")}>Thúy Kiều</h3>
                  </div>
                </Grid>
                <Grid item xs={12} sm={6} md={4} className={cx("_item")}>
                  <div className={cx("item")}>
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url('https://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-4-150x150.png')",
                      }}
                    ></div>
                    <p className={cx("detail")}>
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                    ...
                    <h3 className={cx("name")}>Nguyễn Du</h3>
                  </div>
                </Grid>
                <Grid item xs={12} sm={6} md={4} className={cx("_item")}>
                  <div className={cx("item")}>
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url('https://mauweb.monamedia.net/donghohaitrieu/wp-content/uploads/2019/07/customer-3-150x150.png')",
                      }}
                    ></div>
                    <p className={cx("detail")}>
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                    ...
                    <h3 className={cx("name")}>Thúy Vân</h3>
                  </div>
                </Grid>
              </Grid>
            </div>
