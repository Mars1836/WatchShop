        ...
        <div className="first_intro">
          <Box>
            <Grid container spacing={2} justifyContent="center">
              ...
              <Grid item xs={12} sm={8} md={6} alignItems="center">
                <div className="detail">
                  <h1 className="title">Giới thiệu về Watch Mona</h1>
                  <div className="text">
                    ...
                    chiếc đồng hồ nam cao cấp chính hãng khắc họa một giá trị
                    đích thực khi nói đến phụ kiện xa xỉ dành cho phái mạnh.
                    Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                    những người đàn ông hiện đại ngày nay. Trên cổ tay của những
                    người đàn ông thành đạt luôn dành vị trí cho một chiếc đồng
                    hồ nam cao cấp.”
                  </div>
                </div>
              </Grid>
            ...
            <Grid container spacing={2} justifyContent="center">
              <Grid item xs={12} sm={6} md={4}>
                <div className="item">
                  ...
                  <div className="text">
                    <h2 className="title">Hàng chính hãng</h2>
                    <p className="detail">
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
      		...
      		l48.625,67.609l-12.356-83.253l26.116-11.27l51.831,67.718l-16.091-83.145l22.1-9.54l20.516,120.123L464.248,309.08z"
                  ...
                  <div className="text">
                    <h2 className="title">Sản phẩm mới 100%</h2>
                    <p className="detail">
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                      những người đàn ông hiện đại ngày nay
                    </p>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <div className="item">
                  ...
                  <div className="text">
                    <h2 className="title">Bảo hành 12 tháng</h2>
                    <p className="detail">
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                      những người đàn ông hiện đại ngày nay
                    </p>
      		...
      		z M49.498,25v23.45l15.027,15.024l4.949-4.949L56.5,45.55V25H49.498z"
                  ...
                  <div className="text">
                    <h2 className="title">Đổi trả trong vòng 7 ngày</h2>
                    <p className="detail">
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                      những người đàn ông hiện đại ngày nay
                    </p>
      		...
      		c0-11.415,9.286-20.702,20.701-20.702c11.419,0,20.709,9.287,20.709,20.702C322.4,305.817,313.11,315.104,301.691,315.104z
      		 M263.206,187.26v-54.948h27.085c10.395,0,23.217,7.8,27.979,16.988l17.525,35.482c0.452,0.873,0.924,1.698,1.419,2.478H263.206z"
                  ...
                  <div className="text">
                    <h2 className="title">Miễn phí giao hàng</h2>
                    <p className="detail">
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                      những người đàn ông hiện đại ngày nay
                    </p>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <div className="item">
                  ...
                  <div className="text">
                    <h2 className="title">Giá cả hợp lý</h2>
                    <p className="detail">
                      Hiện nay, đồng hồ là phụ kiện thời trang thiết yếu đối với
                      những người đàn ông hiện đại ngày nay
                    </p>
